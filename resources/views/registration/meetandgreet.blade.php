...
@section('innercontent')
  ...
  @foreach($people as $person)
    ...
    {{-- Invoice --}}
    <div class="card mb-3"><h3 class="card-header text-white bg-primary">Invoice</h3><div class="card-body">
    ...
    {{-- Receipts --}}
    <div class="card mb-3"><h3 class="card-header text-white bg-primary">Receipts</h3><div class="card-body">
      <h4>Card payments</h4>
      @php
