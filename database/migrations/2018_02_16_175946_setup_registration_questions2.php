  ...
  public function up()
  {
    ...
    DB::table('rego_questions')->insert([
      [
        ...
        'questiontext' => 'The following personal information can be distributed to other choristers',
        'questiondescr' => NULL,
        'responseformat' => 'subquestion-radio:Name|Mobile number|Choirs:Yes|No',
