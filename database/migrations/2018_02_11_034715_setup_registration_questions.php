  ...
  public function up()
  {
    ...
    DB::table('rego_questions')->insert([
      ...
      [
        ...
        'questiondescr' => 'Check all the apply. ‘As a chorister’ includes camp and singing only. ‘At social events’ includes the academic dinner, PCP and BBQ.',
    ...
    DB::table('rego_questions')->insert([
      ...
      [
        ...
        'questiondescr' => NULL,
        'responseformat' => 'checkbox:Graduate Singers (Grads)^Grads|Elder Conservatorium Chorale^Chorale|Pilgrim Church^Pilgrim|Christ Church, North Adelaide^CCNA',
        'responsevalidationlogic' => 'required',
        'html5required' => False,
        'companionresponsevalidationlogic' => NULL,
      ],
    ...
    DB::table('rego_questions')->insert([
      [
        ...
        'questiondescr' => 'For $18, linen can be provided for your stay at camp, otherwise you need to bring your own sheets/blankets or sleeping bag. If you are not sleeping at camp, be sure to arrange your own accommodation and commute to and from camp every day.',
        'responseformat' => 'radio:Yes, I’m bringing my own linen^yes, without linen hire|Yes, I’d like to hire linen^yes, with linen hire|no',
        'responsevalidationlogic' => 'required',
        'html5required' => True,
        'companionresponsevalidationlogic' => NULL,
      ],
      [
        ...
        'questiontext' => 'Name and address of apartment/hotel for any accommodation you are staying at',
    ...
    $sectionid = DB::table('rego_sections')->insertGetId([
      ...
      'sectiondescr' => 'Hosts will need to provide sleeping space, bathroom, access (e.g. lending a spare key or being available to unlock in evenings) and luggage storage. It is customary to offer breakfast, no other meals are necessary. You may expect a gift from your guests.',
    ],'sectionid');
    ...
    DB::table('rego_questions')->insert([
      ...
      [
        ...
        'questiontext' => 'Service animal friendly',
        'questiondescr' => NULL,
        'responseformat' => 'radio:Yes|No',
        'responsevalidationlogic' => 'required',
        'html5required' => True,
    ...
    DB::table('rego_questions')->insert([
      [
        ...
        'responseformat' => 'subquestion-radio:Peanuts|Tree nuts|Milk|Eggs|Sesame|Fish|Shellfish|Soy|Wheat|Lupin|Sulfites|OtherText:Yes, severely^severe|Yes, mildly^mild|!No',
        'responsevalidationlogic' => 'required',
        'html5required' => True,
        'companionresponsevalidationlogic' => NULL,
      ],
    ...
    DB::table('rego_questions')->insert([
      [
        ...
        'questiondescr' => NULL,
        'responseformat' => 'checkbox:Red meat|Poultry|Pork|Fish|Other seafood|Eggs|Honey|Gelatin|Dairy',
        'responsevalidationlogic' => 'required',
        'html5required' => True,
        'companionresponsevalidationlogic' => NULL,
      ],
